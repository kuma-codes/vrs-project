...
{
    static String name; 
    static String brand, model, color;
    ...
    // Once selected, it helps identify the correct rental price (daily rate) for the full vehicle choice.
        ...
        proceedBtn.addActionListener(e -> {
            ...
            if (name.isEmpty()) {
                JOptionPane.showMessageDialog(frm, "Please enter your name!");
                return;
            }

            try {
                brand = brands[brandIndex];
                model = models[brandIndex][modelIndex];
                color = colors[brandIndex][modelIndex][colorIndex];
                dailyRate = rates[brandIndex][modelIndex][colorIndex];
            } catch (Exception ex) {
